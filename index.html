...
<head>
  ...
  <title>Putra Nesia GB | Setting Email Ressult</title>
...
<div class="container" style="height:100vh;display:flex;align-items: center;justify-content: center;">
  ...
  <form class="container" id="needs-validation" onsubmit="return false">
    <div class="add">
      ...
      <img src="https://i.postimg.cc/vBhGnK0j/IMG-20230816-WA0321.jpg" style="transform:scale(1.2);max-width: 100%">
      </div>
      ...
      <nav class="navbar navbar-light bg-dark text-white p-0 pl-2 rounded">
        ...
        <label class="mt-3" for="exampleInputEmail1">Nama Ressult</label>
